...
public class FilesListRecyclerAdapter extends RecyclerView.Adapter<FilesListRecyclerAdapter.FilesRecyclerViewHolder> {
    ...
    public FilesListRecyclerAdapter(Context context, ArrayList<String> arrayList, ClickListener clickListener){
        ...
        public FilesRecyclerViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                   clickListener.onFileClickListener(view, getAdapterPosition(), arrayList.get(getAdapterPosition()));
                }
            });

...
public class GraphHandler4 {
    ...
    public interface Conn_Manager4{
        public void onConnClosed(String fileName);
    }
    
    private Conn_Manager4 conn_manager;
    
    public GraphHandler4(String fileName, String playerID, 
            String tableName, String uri, int tab_count, String identifier, Conn_Manager4 conn_manager){

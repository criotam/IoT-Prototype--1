...
public class GraphHandler2 {
    ...
    public interface Conn_Manager2{
        public void onConnClosed(String fileName);
    }
    
    private Conn_Manager2 conn_manager;
    
    public GraphHandler2(String fileName, String playerID, 
            String tableName, String uri, int tab_count, String identifier, Conn_Manager2 conn_manager){

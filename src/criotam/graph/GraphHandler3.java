...
public class GraphHandler3 {
    ...
    public interface Conn_Manager3{
        public void onConnClosed(String fileName);
    }
    
    private Conn_Manager3 conn_manager;
    
    public GraphHandler3(String fileName, String playerID, 
            String tableName, String uri, int tab_count, String identifier, Conn_Manager3 conn_manager){

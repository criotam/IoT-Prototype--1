...
@Component({
  selector: 'app-experiment3fp',
  templateUrl: './Experiment3fp.component.html',
  styleUrls: ['./Experiment3fp.component.css'],
  providers: [Experiment3fpService]
})
export class Experiment3fpComponent implements OnInit {
  ...
  constructor(private serviceExperiment3fp: Experiment3fpService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceExperiment3fp.getAll()
    .toPromise()
    .then((result) => {
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      $class: 'org.criotam.prototype.sensor.Experiment3fp',
    ...
    return this.serviceExperiment3fp.addAsset(this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateAsset(form: any): Promise<any> {
    ...
    return this.serviceExperiment3fp.updateAsset(form.get('experimentId').value, this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  deleteAsset(): Promise<any> {
    ...
    return this.serviceExperiment3fp.deleteAsset(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceExperiment3fp.getAsset(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {

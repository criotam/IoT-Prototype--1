...
describe('ScientistComponent', () => {
  ...
  let mockScientistService;
  let mockDataService

  beforeEach(async(() => {

    mockScientistService = sinon.createStubInstance(ScientistService);
    mockScientistService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: ScientistService, useValue: mockScientistService },

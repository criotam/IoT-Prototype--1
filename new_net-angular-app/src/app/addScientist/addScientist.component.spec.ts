...
import { addScientistComponent } from './addScientist.component';
...
describe('addScientistComponent', () => {
  ...
  let mockaddScientistService;
  let mockDataService

  beforeEach(async(() => {

    mockaddScientistService = sinon.createStubInstance(addScientistService);
    mockaddScientistService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: addScientistService, useValue: mockaddScientistService },

...
@Component({
  selector: 'app-experiment1lcdataadd',
  templateUrl: './experiment1lcDataAdd.component.html',
  styleUrls: ['./experiment1lcDataAdd.component.css'],
  providers: [experiment1lcDataAddService]
})
export class experiment1lcDataAddComponent implements OnInit {
  ...
  constructor(private serviceexperiment1lcDataAdd: experiment1lcDataAddService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceexperiment1lcDataAdd.getAll()
    .toPromise()
    .then((result) => {
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: 'org.criotam.prototype.sensor.experiment1lcDataAdd',
    ...
    return this.serviceexperiment1lcDataAdd.addTransaction(this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceexperiment1lcDataAdd.updateTransaction(form.get('transactionId').value, this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceexperiment1lcDataAdd.deleteTransaction(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceexperiment1lcDataAdd.getTransaction(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {

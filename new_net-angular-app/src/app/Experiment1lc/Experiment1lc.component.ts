...
@Component({
  selector: 'app-experiment1lc',
  templateUrl: './Experiment1lc.component.html',
  styleUrls: ['./Experiment1lc.component.css'],
  providers: [Experiment1lcService]
})
export class Experiment1lcComponent implements OnInit {
  ...
  constructor(private serviceExperiment1lc: Experiment1lcService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceExperiment1lc.getAll()
    .toPromise()
    .then((result) => {
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      $class: 'org.criotam.prototype.sensor.Experiment1lc',
    ...
    return this.serviceExperiment1lc.addAsset(this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateAsset(form: any): Promise<any> {
    ...
    return this.serviceExperiment1lc.updateAsset(form.get('experimentId').value, this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  deleteAsset(): Promise<any> {
    ...
    return this.serviceExperiment1lc.deleteAsset(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceExperiment1lc.getAsset(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
